...
const Movie = require('../models/Movie'); // we call our Book model from here
...
const movies = [
  ...
  Movie.create(movies, (err) => { // on n'utilise pas de promesse mais une fonction call back error first
  if (err) { throw(err) }
